...
class Waveform2(Exceptionable, Configurable, Saveable):
    """
    ...
    def init_post_config(self):
        ...
        # get mode
        # TODO: FIX THIS IN SIM/CONFIGURABLE??
        self.mode = self.search_multi_mode(Config.SIM, WaveformMode)[0]
    ...
    def generate(self):
        ...
        path_to_specific_parameters = [WaveformMode.parameters, str(self.mode).split('.')[-1]]

        frequency = self.search(Config.MODEL, *path_to_specific_parameters, 'frequency')

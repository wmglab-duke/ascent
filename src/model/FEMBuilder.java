...
//        ((Model) mw.getModel()).save("directory");
    ...
    private static void definePrimitiveSelections(Model model, Set parts) {
        ...
        // Ribbon contact primitive
        if (parts.contains("RibbonContact_Primitive")) {
            System.out.println("Adding RibbonContact_Primitive Default Selections");
        ...
        // Wire contact primitive
        if (parts.contains("WireContact_Primitive")) {
            System.out.println("Adding WireContact_Primitive Default Selections");
        ...
        // Circle contact primitive
        if (parts.contains("CircleContact_Primitive")) {
            System.out.println("Adding CircleContact_Primitive Default Selections");
    ...
    private static void definePrimitivePartOperations(Model model, Set parts) {

        //PRIMITIVE, Defined operations for part definition

        // Tube cuff primitive
        if (parts.contains("TubeCuff_Primitive")) {
            System.out.println("Adding TubeCuff_Primitive Part Operations");
        ...
        // Ribbon contact primitive
        if (parts.contains("RibbonContact_Primitive")) {
            System.out.println("Adding RibbonContact_Primitive Part Operations");
        ...
        // Wire contact primitive
        if (parts.contains("WireContact_Primitive")) {
            System.out.println("Adding WireContact_Primitive Part Operations");
        ...
        // Circle Contact Primitive
        if (parts.contains("CircleContact_Primitive")) {
            System.out.println("Adding CircleContact_Primitive Part Operations");
        ...
        // BENT RECTANGLE CONTACT WITH FILLET CORNERS PRIMITIVE
        if (parts.contains("RectangleContact_Primitive")) {
            System.out.println("Adding RectangleContact_Primitive Part Operations");

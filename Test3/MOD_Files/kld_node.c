...
#define nrn_init _nrn_init__kld_node
#define _nrn_initial _nrn_initial__kld_node
#define nrn_cur _nrn_cur__kld_node
#define _nrn_current _nrn_current__kld_node
#define nrn_jacob _nrn_jacob__kld_node
#define nrn_state _nrn_state__kld_node
#define _net_receive _net_receive__kld_node 
#define state state__kld_node 
...
extern Memb_func* memb_func;
 ...
 "setdata_kld_node", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define D D_kld_node
 double D = 1.85;
#define kbath kbath_kld_node
 double kbath = 2.6;
 ...
 "D_kld_node", &D_kld_node,
 "kbath_kld_node", &kbath_kld_node,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "diam");
 	...
 	ivoc_help("help ?1 kld_node D:/Documents/access/Test3/MOD_Files/kld_node.mod\n");

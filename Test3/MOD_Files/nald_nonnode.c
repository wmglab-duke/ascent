...
#define nrn_init _nrn_init__nald_nonnode
#define _nrn_initial _nrn_initial__nald_nonnode
#define nrn_cur _nrn_cur__nald_nonnode
#define _nrn_current _nrn_current__nald_nonnode
#define nrn_jacob _nrn_jacob__nald_nonnode
#define nrn_state _nrn_state__nald_nonnode
#define _net_receive _net_receive__nald_nonnode 
#define state state__nald_nonnode 
...
extern Memb_func* memb_func;
 ...
 "setdata_nald_nonnode", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define D D_nald_nonnode
 double D = 1.15;
#define nabath nabath_nald_nonnode
 double nabath = 154;
 ...
 "D_nald_nonnode", "um2/ms",
 "nabath_nald_nonnode", "mM",
 "txfer_nald_nonnode", "ms",
 "fhspace_nald_nonnode", "um",
 "Vol_peri_nald_nonnode", "cm3",
 "A_peri_nald_nonnode", "um2",
 "SA_nald_nonnode", "cm2",
 "nseg_nald_nonnode", "1",
 "L_nald_nonnode", "um",
 "lseg_nald_nonnode", "cm",
 0,0
};
 ...
 "D_nald_nonnode", &D_nald_nonnode,
 "nabath_nald_nonnode", &nabath_nald_nonnode,
 0,0
};
...
"nald_nonnode",
 "txfer_nald_nonnode",
 "fhspace_nald_nonnode",
 0,
 "Vol_peri_nald_nonnode",
 "A_peri_nald_nonnode",
 "SA_nald_nonnode",
 "nseg_nald_nonnode",
 "L_nald_nonnode",
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "diam");
 	...
 	ivoc_help("help ?1 nald_nonnode D:/Documents/access/Test3/MOD_Files/nald_nonnode.mod\n");

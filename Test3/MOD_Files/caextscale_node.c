...
#define nrn_init _nrn_init__caextscale_node
#define _nrn_initial _nrn_initial__caextscale_node
#define nrn_cur _nrn_cur__caextscale_node
#define _nrn_current _nrn_current__caextscale_node
#define nrn_jacob _nrn_jacob__caextscale_node
#define nrn_state _nrn_state__caextscale_node
#define _net_receive _net_receive__caextscale_node 
#define state state__caextscale_node 
...
extern Memb_func* memb_func;
 ...
 "setdata_caextscale_node", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define D D_caextscale_node
 double D = 1.85;
#define cabath cabath_caextscale_node
 double cabath = 2;
 ...
 "D_caextscale_node", "um2/ms",
 "cabath_caextscale_node", "mM",
 "txfer_caextscale_node", "ms",
 "fhspace_caextscale_node", "um",
 "Vol_peri_caextscale_node", "cm3",
 "A_peri_caextscale_node", "um2",
 "SA_caextscale_node", "cm2",
 "nseg_caextscale_node", "1",
 "L_caextscale_node", "um",
 "lseg_caextscale_node", "cm",
 0,0
};
 ...
 "D_caextscale_node", &D_caextscale_node,
 "cabath_caextscale_node", &cabath_caextscale_node,
 0,0
};
...
#define _cvode_ieq _ppvar[5]._i
 ...
 "6.2.0",
"caextscale_node",
 "txfer_caextscale_node",
 "fhspace_caextscale_node",
 0,
 "Vol_peri_caextscale_node",
 "A_peri_caextscale_node",
 "SA_caextscale_node",
 "nseg_caextscale_node",
 "L_caextscale_node",
 "lseg_caextscale_node",
 0,
 0,
 0};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "diam");
 	...
 	ivoc_help("help ?1 caextscale_node D:/Documents/access/Test3/MOD_Files/caextscale_node.mod\n");
...
_MATELM1(0, 0) *= ( A_peri);  }
 ...
 f_flux = b_flux = 0.;
 _RHS1( 0) += (b_flux =   ( - ( D * ( cabath - cao ) * PI * ( diam + fhspace ) ) / fhspace ) );
 /*FLUX*/
    } return _reset;
 }
 ...
 */
 ...
 /*FLUX*/
  /* ~ cao < < ( - ( D * ( cabath - cao ) * PI * ( diam + fhspace ) ) / fhspace )*/
 f_flux = b_flux = 0.;
 Dcao += (b_flux =   ( - ( D * ( cabath - cao ) * PI * ( diam + fhspace ) ) / fhspace ) );
 /*FLUX*/
  _p[_dlist1[0]] /= ( A_peri);
   } return _reset;
 }

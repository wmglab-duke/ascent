...
#define nrn_init _nrn_init__caext
#define _nrn_initial _nrn_initial__caext
#define nrn_cur _nrn_cur__caext
#define _nrn_current _nrn_current__caext
#define nrn_jacob _nrn_jacob__caext
#define nrn_state _nrn_state__caext
#define _net_receive _net_receive__caext 
#define state state__caext 
...
extern Memb_func* memb_func;
 ...
 "setdata_caext", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define SA SA_caext
 double SA = 2.82743e-005;
#define Vol_peri Vol_peri_caext
 double Vol_peri = 1.46136e-009;
#define cabath cabath_caext
 double cabath = 2;
 ...
 "cabath_caext", &cabath_caext,
 "SA_caext", &SA_caext,
 "Vol_peri_caext", &Vol_peri_caext,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 caext D:/Documents/access/First_NeuronSim/MOD_Files/caext.mod\n");

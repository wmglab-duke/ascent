...
#define nrn_init _nrn_init__cainttest
#define _nrn_initial _nrn_initial__cainttest
#define nrn_cur _nrn_cur__cainttest
#define _nrn_current _nrn_current__cainttest
#define nrn_jacob _nrn_jacob__cainttest
#define nrn_state _nrn_state__cainttest
#define _net_receive _net_receive__cainttest 
#define state state__cainttest 
...
extern Memb_func* memb_func;
 ...
 "setdata_cainttest", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define SA SA_cainttest
 double SA = 7.66242e-007;
#define Vol Vol_cainttest
 double Vol = 1.9e-011;
#define nb nb_cainttest
 double nb = 4;
 ...
 "nb_cainttest", &nb_cainttest,
 "SA_cainttest", &SA_cainttest,
 "Vol_cainttest", &Vol_cainttest,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 cainttest D:/Documents/access/First_NeuronSim/MOD_Files/cainttest.mod\n");

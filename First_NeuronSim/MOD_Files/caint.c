...
#define nrn_init _nrn_init__caint
#define _nrn_initial _nrn_initial__caint
#define nrn_cur _nrn_cur__caint
#define _nrn_current _nrn_current__caint
#define nrn_jacob _nrn_jacob__caint
#define nrn_state _nrn_state__caint
#define _net_receive _net_receive__caint 
#define state state__caint 
...
extern Memb_func* memb_func;
 ...
 "setdata_caint", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define SA SA_caint
 double SA = 2.82743e-005;
#define Vol Vol_caint
 double Vol = 1.27e-008;
#define nb nb_caint
 double nb = 4;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 caint D:/Documents/access/First_NeuronSim/MOD_Files/caint.mod\n");

...
#define nrn_init _nrn_init__axnode_myel
#define _nrn_initial _nrn_initial__axnode_myel
#define nrn_cur _nrn_cur__axnode_myel
#define _nrn_current _nrn_current__axnode_myel
#define nrn_jacob _nrn_jacob__axnode_myel
#define nrn_state _nrn_state__axnode_myel
#define _net_receive _net_receive__axnode_myel 
#define evaluate_fct evaluate_fct__axnode_myel 
#define states states__axnode_myel 
...
extern Memb_func* memb_func;
 ...
 "setdata_axnode_myel", _hoc_setdata,
 "Exp_axnode_myel", _hoc_Exp,
 "evaluate_fct_axnode_myel", _hoc_evaluate_fct,
 "vtrap11_axnode_myel", _hoc_vtrap11,
 "vtrap10_axnode_myel", _hoc_vtrap10,
 "vtrap9_axnode_myel", _hoc_vtrap9,
 "vtrap8_axnode_myel", _hoc_vtrap8,
 "vtrap7_axnode_myel", _hoc_vtrap7,
 "vtrap6_axnode_myel", _hoc_vtrap6,
 "vtrap2_axnode_myel", _hoc_vtrap2,
 "vtrap1_axnode_myel", _hoc_vtrap1,
 0, 0
};
#define Exp Exp_axnode_myel
#define vtrap11 vtrap11_axnode_myel
#define vtrap10 vtrap10_axnode_myel
#define vtrap9 vtrap9_axnode_myel
#define vtrap8 vtrap8_axnode_myel
#define vtrap7 vtrap7_axnode_myel
#define vtrap6 vtrap6_axnode_myel
#define vtrap2 vtrap2_axnode_myel
#define vtrap1 vtrap1_axnode_myel
...
#define asC asC_axnode_myel
 double asC = -5;
#define asB asB_axnode_myel
 double asB = -27;
#define asA asA_axnode_myel
 double asA = 0.3;
#define ahC ahC_axnode_myel
 double ahC = 11;
#define ahB ahB_axnode_myel
 double ahB = 114;
#define ahA ahA_axnode_myel
 double ahA = 0.062;
#define amC amC_axnode_myel
 double amC = 10.3;
#define amB amB_axnode_myel
 double amB = 21.4;
#define amA amA_axnode_myel
 double amA = 1.86;
#define ampC ampC_axnode_myel
 double ampC = 10.2;
#define ampB ampB_axnode_myel
 double ampB = 27;
#define ampA ampA_axnode_myel
 double ampA = 0.01;
#define bsC bsC_axnode_myel
 double bsC = -1;
#define bsB bsB_axnode_myel
 double bsB = 10;
#define bsA bsA_axnode_myel
 double bsA = 0.03;
#define bhC bhC_axnode_myel
 double bhC = 13.4;
#define bhB bhB_axnode_myel
 double bhB = 31.8;
#define bhA bhA_axnode_myel
 double bhA = 2.3;
#define bmC bmC_axnode_myel
 double bmC = 9.16;
#define bmB bmB_axnode_myel
 double bmB = 25.7;
#define bmA bmA_axnode_myel
 double bmA = 0.086;
#define bmpC bmpC_axnode_myel
 double bmpC = 10;
#define bmpB bmpB_axnode_myel
 double bmpB = 34;
#define bmpA bmpA_axnode_myel
 double bmpA = 0.00025;
#define vtraub vtraub_axnode_myel
 double vtraub = -80;
 ...
 "gnapbar_axnode_myel", "mho/cm2",
 "gnabar_axnode_myel", "mho/cm2",
 "gkbar_axnode_myel", "mho/cm2",
 "gl_axnode_myel", "mho/cm2",
 "ena_axnode_myel", "mV",
 "ek_axnode_myel", "mV",
 "el_axnode_myel", "mV",
 "inap_axnode_myel", "mA/cm2",
 "ina_axnode_myel", "mA/cm2",
 "ik_axnode_myel", "mA/cm2",
 "il_axnode_myel", "mA/cm2",
 0,0
};
 ...
 "vtraub_axnode_myel", &vtraub_axnode_myel,
 "ampA_axnode_myel", &ampA_axnode_myel,
 "ampB_axnode_myel", &ampB_axnode_myel,
 "ampC_axnode_myel", &ampC_axnode_myel,
 "bmpA_axnode_myel", &bmpA_axnode_myel,
 "bmpB_axnode_myel", &bmpB_axnode_myel,
 "bmpC_axnode_myel", &bmpC_axnode_myel,
 "amA_axnode_myel", &amA_axnode_myel,
 "amB_axnode_myel", &amB_axnode_myel,
 "amC_axnode_myel", &amC_axnode_myel,
 "bmA_axnode_myel", &bmA_axnode_myel,
 "bmB_axnode_myel", &bmB_axnode_myel,
 "bmC_axnode_myel", &bmC_axnode_myel,
 "ahA_axnode_myel", &ahA_axnode_myel,
 "ahB_axnode_myel", &ahB_axnode_myel,
 "ahC_axnode_myel", &ahC_axnode_myel,
 "bhA_axnode_myel", &bhA_axnode_myel,
 "bhB_axnode_myel", &bhB_axnode_myel,
 "bhC_axnode_myel", &bhC_axnode_myel,
 "asA_axnode_myel", &asA_axnode_myel,
 "asB_axnode_myel", &asB_axnode_myel,
 "asC_axnode_myel", &asC_axnode_myel,
 "bsA_axnode_myel", &bsA_axnode_myel,
 "bsB_axnode_myel", &bsB_axnode_myel,
 "bsC_axnode_myel", &bsC_axnode_myel,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 axnode_myel D:/Documents/access/First_NeuronSim/MOD_Files/AXNODE_myel.mod\n");

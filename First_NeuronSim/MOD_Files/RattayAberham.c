...
#define usetable usetable_RattayAberham
 ...
 "gl_RattayAberham", 0, 1e+009,
 "gkbar_RattayAberham", 0, 1e+009,
 "gnabar_RattayAberham", 0, 1e+009,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "cvodeieq");
 	...
 	ivoc_help("help ?1 RattayAberham D:/Documents/access/First_NeuronSim/MOD_Files/RattayAberham.mod\n");

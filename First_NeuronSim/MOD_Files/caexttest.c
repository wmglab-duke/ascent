...
#define nrn_init _nrn_init__caexttest
#define _nrn_initial _nrn_initial__caexttest
#define nrn_cur _nrn_cur__caexttest
#define _nrn_current _nrn_current__caexttest
#define nrn_jacob _nrn_jacob__caexttest
#define nrn_state _nrn_state__caexttest
#define _net_receive _net_receive__caexttest 
#define state state__caexttest 
...
extern Memb_func* memb_func;
 ...
 "setdata_caexttest", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define SA SA_caexttest
 double SA = 7.66242e-007;
#define Vol_peri Vol_peri_caexttest
 double Vol_peri = 1.98017e-012;
#define cabath cabath_caexttest
 double cabath = 2;
 ...
 "cabath_caexttest", "mM",
 "SA_caexttest", "cm2",
 "Vol_peri_caexttest", "cm3",
 "fhspace_caexttest", "cm",
 "txfer_caexttest", "ms",
 0,0
};
 ...
 "cabath_caexttest", &cabath_caexttest,
 "SA_caexttest", &SA_caexttest,
 "Vol_peri_caexttest", &Vol_peri_caexttest,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 caexttest D:/Documents/access/First_NeuronSim/MOD_Files/caexttest.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {int _reset = 0; {
   Dcao = ica * SA / ( 2.0 * Vol_peri * FARADAY ) + ( cao - cabath ) / txfer ;
   }
 return _reset;
}

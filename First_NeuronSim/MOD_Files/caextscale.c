...
#define Vol_periSchild Vol_periSchild_caextscale
 double Vol_periSchild = 1.46136e-009;
#define VolSchild VolSchild_caextscale
 double VolSchild = 1.41372e-008;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "diam");
 	...
 	ivoc_help("help ?1 caextscale D:/Documents/access/First_NeuronSim/MOD_Files/caextscale.mod\n");

...
* **Cite the code (use the DOI for the version of code used):** |doi|
  ...
  .. details:: APA
     ...
     **Musselman, E. D.**, **Cariello, J. E.**, Grill, W. M., & Pelot, N. A. (2023). wmglab-duke/ascent: ASCENT v1.2.1 (v1.2.1) [Computer software]. Zenodo. https://doi.org/10.5281/ZENODO.TBD

  .. details:: MLA

      Musselman, Eric D., et al. Wmglab-Duke/Ascent: ASCENT v1.2.1. v1.2.1, Zenodo, 2023, doi:10.5281/ZENODO.TBD.

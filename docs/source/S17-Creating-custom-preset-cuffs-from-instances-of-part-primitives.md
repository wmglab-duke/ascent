...
assemble into their own cuffs in the COMSOL GUI. See [S18 Text](https://github.com/wmglab-duke/ascent/wiki/S18:-Creating-new-part-primitives) for instructions on how to add new part primitives. After a part primitive

/*
 * MADISON_FINAL_wRECESS.java
 */

import com.comsol.model.*;
import com.comsol.model.util.*;

/** Model exported on Aug 22 2019, 18:09 by COMSOL 5.4.0.388. */
public class MADISON_FINAL_wRECESS {
  ...
  public static Model run() {
    ...
    model.label("MADISON_FINAL_wRECESS.mph");
    ...
    model.param().set("recess", "0.05 [mm]");
    ...
    model.geom("part2").feature("wp1").geom().feature("r1")
         .set("pos", new String[]{"r_cuff_in+(recess)+(thk_elec/2)", "z_src"});
    ...
    model.geom("part2").feature("wp2").label("Recess Radial Cross Section 1");
    ...
    model.geom("part2").feature("wp2").geom().feature("r1").label("Recess Radial Cross Section");
    model.geom("part2").feature("wp2").geom().feature("r1").set("contributeto", "csel2");
    model.geom("part2").feature("wp2").geom().feature("r1")
         .set("pos", new String[]{"r_cuff_in+(recess/2)", "z_src"});
    ...
    model.geom("part2").feature("rev2").set("angle1", "(rotation_angle)-(theta_elec/2)");
    model.geom("part2").feature("rev2").set("angle2", "(rotation_angle)+(theta_elec/2)");
    ...
    model.geom("part2").feature("pt1")
         .set("p", new String[]{"(r_cuff_in+recess+thk_elec/2)*cos(rotation_angle)", "(r_cuff_in+recess+thk_elec/2)*sin(rotation_angle)", "z_src"});
    ...
    model.component("comp1").material("matlnk5").selection().named("geom1_pi3_csel1_dom");
    ...
    model.component("comp1").material("matlnk4").selection().named("geom1_pi2_csel5_dom");
    ...
    model.view("view5").axis().set("xmin", 0.0011009614681825042);
    model.view("view5").axis().set("xmax", 0.002156063448637724);
    model.view("view5").axis().set("ymin", -5.749433184973896E-4);
    model.view("view5").axis().set("ymax", 5.749433184973896E-4);
    model.view("view6").label("View 6");
    model.view("view7").label("View 7");
    model.view("view8").axis().set("ymin", -1.4044586420059204);
    model.view("view8").axis().set("ymax", 1.4044586420059204);

    model.component("comp1").material("matlnk3").label("Medium is Muscle");
    model.component("comp1").material("matlnk3").set("link", "mat3");
    model.component("comp1").material("matlnk5").label("Cuff Fill is Saline");
    ...
    model.component("comp1").material("matlnk4").label("Recess is Saline");

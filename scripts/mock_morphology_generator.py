...
def run(args):
    ...
    """
    warnings.warn("There is a known issue where the mock morphology generator will create nerve morphologies with areas slightly smaller than requested. A fix is in progress.",stacklevel=2)
    start = time.time()
